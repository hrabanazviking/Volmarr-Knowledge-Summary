# Frith and Hospitality

## In Brief

The inviolable boundary of mutual peace, safety, and sanctuary centered on the hearth and community, binding host and guest in reciprocal respect.
...
- **Prerequisites:** [Relational Worldview](../01_FOUNDATIONS/02_Relational_Worldview.md), [Troth and Reciprocity](./01_Troth_and_Reciprocity.md)
- **Informs Later Concepts:** [Heathen Third Path](../01_FOUNDATIONS/04_Heathen_Third_Path.md)
...
Material categorized under: `metaphorical`, `modern_heathen_practice`, `philosophical`, `ritual_instruction`, `speculative`, `theology`.
